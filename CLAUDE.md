...
6. **Friend-mode navigation** — `js/sidebar.js` and `js/mobile-nav.js` now render a shorter,
   ...
   (`resume.html`, `expenses.html`, `reports.html`, `time-capsule.html`, `constellation.html`)
